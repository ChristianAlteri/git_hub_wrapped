...
export async function fetchGitHubData(username) {
    try {
      ...
      const favouriteLanguage = calculateMostFrequentLanguages(repos, languages);
  
      return { favouriteLanguage, biggestRepo, biggestSize, repos, languages };
    } catch (error) {
      console.error(error);
    }
  }
